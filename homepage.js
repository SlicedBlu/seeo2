$(document).ready(function() {
	$("#calculate").click(function() {
		$("#content").slideToggle(500, function() {
			...
			addHtml += "<div id = \"info\"> Your CO2 rating is <span style=\"color:blue;\">" + result.toLocaleString() + " kg/year</span>, compared to the average of <span style=\"color:blue;\">4,074 kg/year</span>.<br>Try using the \"Resources\" tab at the top to further reduce your usage.";
